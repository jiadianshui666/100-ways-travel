    ...
    <div className="relative">
      ...
      <section className="py-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="px-4 sm:px-6 mb-2 text-lg font-display font-semibold text-white">
            探索分类
          </h2>
        </div>
        <CategoryTabs
          ...
          onChange={(slug) => {
            ...
            setVisualStyle(null); // clear style when category changes
          }}
          loading={catLoading}
        />
      </section>
      ...
      <section className="py-8">
        <div className="max-w-7xl mx-auto mb-6 px-4 sm:px-6 flex items-center justify-between">
          ...
          <span className="hidden sm:inline text-xs text-dark-500 px-3 py-1 rounded-full border border-white/5">
            左右滑动 ← →
          </span>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <FilterBar
            ...
            onStyleChange={(style) => {
              ...
              if (style) setActiveCategory(null);
            }}
